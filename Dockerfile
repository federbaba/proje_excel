...
# KESİN ÇÖZÜM: Caddy konfigürasyon dosyasını GLOBAL BLOK kullanarak oluştur.
# Bu, Render'ın sağlık kontrolünden kaynaklanan "host not allowed" hatasını çözecektir.
